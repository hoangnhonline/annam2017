    ...
    <div class="col-md-9 col-sm-9 col-xs-12 block_cate_right">                        
        <div class="block block_view">
            ...
            <ul class="block_content">
                <li @if($sort=="new") class="active" @endif><a href="javascript:;" data-sort="new" class="sort">Mới nhất</a></li>
                <li @if($sort=="old") class="active" @endif><a href="javascript:;" data-sort="old" class="sort" title="Cũ nhất">Cũ nhất</a></li>
                <li @if($sort=="high") class="active" @endif><a href="javascript:;" data-sort="high" class="sort" title="Giá cao nhất">Giá cao nhất</a></li>
                <li @if($sort=="low") class="active" @endif><a href="javascript:;" data-sort="low" class="sort" title="Giá thấp nhất">Giá thấp nhất</a></li>
            </ul>
